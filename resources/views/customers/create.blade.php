        ...
        <div class="card-body">
            <form action="{{ route('customers.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    placeholder="Nombre" value="{{ old('first_name') }}" require>
                    @error('first_name')
                ...
                <div class="form-group">
                    ...
                    placeholder="Apellido" value="{{ old('last_name') }}" require>
                    @error('last_name')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="form-group">
                    ...
                    placeholder="Email" value="{{ old('email') }}" require>
                    @error('email')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="form-group">
                    ...
                    placeholder="Telefono" value="{{ old('phone') }}" require>
                    @error('phone')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="form-group">
                    ...
                    placeholder="Direccion" value="{{ old('address') }}" require>
                    @error('address')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
